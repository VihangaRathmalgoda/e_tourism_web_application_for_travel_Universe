...
$staff_list='';
$query="SELECT * FROM staff WHERE isavailable=1 AND staff_type_id=1 OR staff_type_id=2 ORDER BY name";
...
if($staff){
    while($staff1=mysqli_fetch_assoc($staff)){
        ...
        if (isset($staff1['staff_type_id']) && $staff1['staff_type_id'] == 1){
            $stafftype='Manager';
        ...
        $staff_list.="<td>{$stafftype}</td>";
        $staff_list.="<td><a href=\"modify-admindashboard.php?id={$staff1['id']}\">   <button class='btn btn-primary btn-sm'>Edit</button></a></td>";
        $staff_list.="<td><a href=\"delete-member.php?id={$staff1['id']}\"><button class='btn btn-danger btn-sm'>Deactivate</button></a></td>";
        $staff_list.="</tr>";
    }
 }
 else{
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">TRAVEL UNIVERSE</div>
            <div class="list-group list-group-flush my-3">
                ...
                <a onclick="location.href='customerdashboard.php'" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i 
                        class="fas fa-chart-line me-2"></i>Customer</a>
